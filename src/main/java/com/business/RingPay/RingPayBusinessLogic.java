...
public class RingPayBusinessLogic extends Utilities {
	...
	public void User_Play_Store_Flow(String validMob, String editMob, String lessThanTenMob,String moreThanTenMob, String specialCharMob,
		...
		promoCodeModule();
		extent.extentLoggerPass("TC_Ring_Core_66",
				"TC_Ring_Core_66 - To verify  user Scans the Promo Code QR");
		...
		logger.info("Verify mobile number with >10 digits");
		mobileNoValidation(moreThanTenMob);
		...
		explicitWaitClickable(RingLoginPage.resendOtpTxt,10);
		extent.extentLoggerPass("TC_Ring_Core_27",
				"TC_Ring_Core_27 - To Verify Resend OTP should clickable");
		
		clearField(RingLoginPage.objOtpTxtField1, "Enter OTP");
		Aclick(RingLoginPage.resendOtpTxt,"Resend OTP");
		explicitWaitVisibility(RingLoginPage.objEditMobNo,10);
		Aclick(RingLoginPage.objEditMobNo, "Edit Mobile number");
		trueCallerPopup();
		explicitWaitVisibility(RingLoginPage.objNoneBtn,10);
		Aclick(RingLoginPage.objNoneBtn, "None of the above");
		mobileNoValidation("8" + RandomIntegerGenerator(9));
		//clearField(RingLoginPage.objOtpTxtField1, "Enter OTP");
		enterOtp("888888");
	...
	public void User_Registration_Flow(String month, String date, String year,String gender) throws Exception{
		...
		extent.extentLoggerPass("TC_Ring_Core_68",
				"TC_Ring_Core_68 - To verify the 'User Details' screen");
		...
		hideKeyboard();
		/*Aclick(UserRegistrationPage.objFirstName,"First name text field");
		type(UserRegistrationPage.objFirstName,"Sachin","First Name text field");
		Aclick(UserRegistrationPage.objLastName,"Last name text field");
		type(UserRegistrationPage.objLastName,"Chatla","Last Name text field");
		Aclick(UserRegistrationPage.objUserEmail,"Email text field");
		Aclick(UserRegistrationPage.objNoneOfAbove,"None of the above button");
		type(UserRegistrationPage.objUserEmail,generateRandomString(6) + "@gmail.com","Email text field");
		hideKeyboard();*/
		userDetails();
		ageSelect("greaterthanequalto18 || lessthanequalto55","Sep","20","1998",1998,20);
		ageCheckGreaterThanEqualTo18AndLessThanEqualTo55("greaterthanequalto18 || lessthanequalto55","Sep","20","1998",1998,20);
	...
	public void merchantFlow() throws Exception
    {
        ...
        /*explicitWaitVisibility(RingPayMerchantFlowPage.objCamPermRequired, 10);
        if(verifyElementPresent(RingPayMerchantFlowPage.objCamPermRequired, getTextVal(RingPayMerchantFlowPage.objCamPermRequired, "Pop Up")))
        {
            click(RingPayMerchantFlowPage.objEnablePermission, "Enable Permission Button");
            if(verifyElementPresent(RingPayMerchantFlowPage.objAllowPermissionPopup, getTextVal(RingPayMerchantFlowPage.objAllowPermissionPopup, "Pop Up")))
            {
                click(RingPayMerchantFlowPage.objAllowPermissionBtn, getTextVal(RingPayMerchantFlowPage.objAllowPermissionBtn, "Button"));
            }
            logger.info("App redirected to QR scanner page");
            extent.extentLogger("QR Code", "App redirected to QR Scanner Page");
        }*/
        ...
        if(verifyIsElementDisplayed(RingPayMerchantFlowPage.objScanQRCodeText, getTextVal(RingPayMerchantFlowPage.objScanQRCodeText, "Text")))
        {
            ...
            extent.extentLogger("Scan QR", "Scanning the QR Code");
        }
        
            verifyIsElementDisplayed(RingPayMerchantFlowPage.objCreditAtZeroPopUp, getTextVal(RingPayMerchantFlowPage.objCreditAtZeroPopUp, "Pop up"));
             waitTime(3000);
...
//            enterOtp("888888");
	...
	public void userDetails() throws Exception {
		...
		waitTime(2000);
		genderSelect("male");
		/*explicitWaitVisibility(RingUserDetailPage.objDOB, 10);
		verifyElementPresentAndClick(RingUserDetailPage.objDOB, "DOB Field");
		Aclick(RingUserDetailPage.objDOB, "DOB Field");
		waitTime(3000);*/
	}
	...
	public void ageSelect(String key, String Month, String Date, String Year, int year, int date) throws Exception {
		...
		case "lessthan18":
			dateOfBirth(Month, Date, Year);
			/*explicitWaitVisibility(RingUserDetailPage.objOKBtn, 10);
			click(RingUserDetailPage.objOKBtn, "Ok Button");*/
		...
		/*waitTime(5000);
		click(RingUserDetailPage.objGender, "Gender DropDown");
		...
		if (age < 18) {
			waitTime(10000);
			logger.info("Age Approved as the age is <18 and the current age is: " + age);
			extent.extentLoggerWarning("age", "Age Approved as the age is <18 and the current age is: " + age);
			waitTime(10000);
			...
			logger.info("Age Approved as the age is >55 and the current age is: " + age);
			extent.extentLoggerWarning("age", "Age Approved as the age is >55 and the current age is: " + age);
			waitTime(10000);
			verifyElementPresent(RingUserDetailPage.objSorryMsg, getText(RingUserDetailPage.objSorryMsg));
			logger.info("Age Criteria Failed");
			extent.extentLogger("Age Verification", "Age Criteria Failed");
			...
			logger.info("Age Approved as the age is >=18 & <=55 and the current age is: " + age);
			extent.extentLogger("age", "Age Approved as the age is >=18 & <=55 and the current age is: " + age);
			waitTime(10000);
			offerScreen();
			logger.info("Age Criteria Passed");
			extent.extentLogger("Age Verification", "Age Criteria Passed");
			/*explicitWaitVisibility(RingUserDetailPage.objHamburgerTabSuccess, 10);
			verifyElementPresentAndClick(RingUserDetailPage.objHamburgerTabSuccess, "Hamburger Tab");
			explicitWaitVisibility(RingUserDetailPage.objProfileTabCompletedPercentage,10);
			verifyElementPresentAndClick(RingUserDetailPage.objProfileTabCompletedPercentage,
					"Profile Completed Percentage tab");
			verifyElementPresentAndClick(RingUserDetailPage.objLogoutBtn, "Logout Button");
			logger.info("Are you sure you want to Logout?");
	...
	public void ageCheckLessThan18(String key, String Month, String Date, String Year1, int year1, int date)throws Exception {
	...
	public void ageCheckGreaterThanEqualTo18AndLessThanEqualTo55(String key,String Month,String Date,String Year2,int year2,int date) throws Exception{
	...
	public void genderSelect(String gender) throws Exception{
		explicitWaitClickable(UserRegistrationPage.objGenderSelect,10);
		Aclick(UserRegistrationPage.objGenderSelect,"Gender dropdown");
		//Aclick(UserRegistrationPage.objGenderSelect,"Gender dropdown");
		if(gender.equalsIgnoreCase("Male")) {
			explicitWaitVisibility(UserRegistrationPage.objMale,10);
			Aclick(UserRegistrationPage.objMale,"Male gender");
			hideKeyboard();
		}
...
//					Aclick(RingLoginPage.objProfileSelect,"Profile Select Button");
	...
	public void valid_otp_200(String url) throws Exception {
		...
		extent.extentLoggerPass("Status Code Validation",
				"OTP API Status Code Validation for positive scenario is successful");
		...
		assertThat(response.extract().body().asString(),
				JsonSchemaValidator.matchesJsonSchemaInClasspath("otp_200_schema.json"));
	...
	public void valid_auth_200(String url) throws Exception {
		...
		Assert.assertEquals(response.extract().statusCode(), 200);
		extent.extentLoggerPass("Status Code Validation",
				"AUTH API Status Code Validation for positive scenario is successful");
		...
		assertThat(response.extract().body().asString(),
				JsonSchemaValidator.matchesJsonSchemaInClasspath("auth_200_schema.json"));
		logger.info("Schema Validation for positive scenario is successful");
		extent.extentLoggerPass("Schema Validation", "Schema Validation for positive scenario is successful");
	}
	...
	public void invalid_auth_400(String url) throws IOException {
		...
		extent.extentLoggerPass("Status Code Validation",
				"AUTH API Status Code Validation for negative scenario is successful");
		String authStatus = String.valueOf(response.extract().statusCode());
		logger.info("AUTH API response status code Validation is Successful");
		extent.extentLoggerPass("AUTH API Status Code", "Repsonse status code is: " + authStatus);
		...
		assertThat(response.extract().body().asString(),
				JsonSchemaValidator.matchesJsonSchemaInClasspath("auth_400_schema.json"));
	...
	public void invalid_otp_400(String url) throws Exception {
		...
		assertThat(response.extract().body().asString(),
				JsonSchemaValidator.matchesJsonSchemaInClasspath("otp_400_schema.json"));
		logger.info("Schema Validation for negative scenario is successful");
